...
from resourses.functions import add_thousand, check_balance_after_game, commit_game_results_to_db, debt_calculator, debt_informer, \
    exiting_game_by_player, get_current_game, get_current_game_stats_for_player, get_group_game_report, \
    get_list_of_id_and_names, get_list_of_players_and_buy_ins, get_mvp, get_players, get_remaining_players_in_game
from resourses.keyboards import add_funds_keyboard, add_keyboard
...
async def game_finisher(call: types.CallbackQuery):
    ...
    if remaining_players:
        ...
        if results.delta != 0:
            ...
            await debt_informer(transactions)
